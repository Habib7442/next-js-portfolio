      ...
      >
        {propTabs.map((tab, idx) => (
          <button
            ...
            className={cn(
              "relative px-2 py-1 sm:px-4 sm:py-2 text-xs sm:text-sm md:text-base rounded-full whitespace-nowrap",
              tabClassName
            )}
            style={{
          ...
          >
            {active.value === tab.value && (
              <motion.div
                ...
                className={cn(
                  "absolute inset-0 bg-gray-200 dark:bg-violet-700 rounded-full",
                  activeTabClassName
                )}
              />
            )}
